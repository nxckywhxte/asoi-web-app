  ...
  return (
    <header className='body-font'>
      <div className='container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center mt-5'>
        ...
        <button className='inline-flex items-center text-gray-50 bg-indigo-800 border-0 py-2 px-3 focus:outline-none hover:bg-indigo-700 rounded text-base mt-4 md:mt-0'>
          Авторизация
        </button>
      </div>
    </header>
